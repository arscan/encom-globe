...
const Pin = function (lat, lon, text, altitude, scene, smokeProvider, _opts) {
...
Pin.prototype.changeAltitude = function (altitude) {
  let point = utils.mapPoint(this.lat, this.lon)
  let _this = this // arghhhh
